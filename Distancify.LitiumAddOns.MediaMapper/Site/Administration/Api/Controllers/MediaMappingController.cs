...
namespace Didriksons.Web.Site.Administration.Api.Controllers
{
    ...
    public class CategoryDataCopyController : BackofficeApiController
    {
        ...
        {
            _backgroundJobClient.Enqueue<MediaMappingJob>(job => job.Execute(mediaMappingRequest.FolderSystemId, mediaMappingRequest.MediaProfiler));
        ...
        public class MediaMappingRequest
        {
            ...
            public string MediaProfiler { get; set; }
        }
    }
}